...
public:
	...
	void AddInstancedMesh(std::string meshName, std::string meshPath, std::string fileName, bool useMaterial = false, bool useTextureFolder = false, bool normalizePositions = false, bool useShader = false);
